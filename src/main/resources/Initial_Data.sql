...
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, color, condition_id, purchaseDate, sellDate) VALUES ('AAA-123456789101', 'swiss nuclear', 'clock', TRUE, 1, 1, 1, 1, '5/12/2012', '7/17/2014');
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, color, condition_id, purchaseDate) VALUES ('BBB-123456789101', 'so comfortable', 'chair', FALSE, 2, 2, 2, 2, '6/16/1993');
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, color, condition_id, purchaseDate) VALUES ('CCC-123456789101', 'extremely plastic', 'cup', FALSE, 3, 3, 3, 3, '3/29/1981');
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, color, condition_id, purchaseDate, sellDate) VALUES ('DDD-123456789101', 'lava', 'lamp', TRUE, 4, 4, 4, 4, '7/2/2014', '2/16/2015');
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, color, condition_id, purchaseDate, sellDate) VALUES ('EEE-123456789101', 'the first magazine i ever read', 'magazine', TRUE, 5, 5, 5, 5, '11/10/1922', '2/29/1984');
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, color, condition_id, purchaseDate, sellDate) VALUES ('FFF-123456789101', 'a diamond encrusted pen', 'pen', TRUE, 1, 6, 6, 2, '10/19/1958', '1/4/1978');
