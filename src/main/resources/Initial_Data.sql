...
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('BBB-223456789101', 'so comfortable', 'chair', FALSE, 2, 2, 2);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('CCC-323456789101', 'extremely plastic', 'cup', FALSE, 3, 3, 3);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('DDD-423456789101', 'lava', 'lamp', TRUE, 4, 4, 4);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('EEE-523456789101', 'the first magazine i ever read', 'magazine', TRUE, 5, 5, 5);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('FFF-623456789101', 'a diamond encrusted pen', 'pen', TRUE, 1, 6, 6);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('ABC-723456789101', 'money', 'baseball', TRUE, 5, 3, 6);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('DEF-823456789101', 'hello...hello? HELLO???', 'phone', TRUE, 5, 4, 6);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('GZZ-923456789101', 'We ARE strangers to love.', 'settler', FALSE, 2, 1, 4);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('ZIE-103456789101', 'Do not leave children unattended with this...unless you want some new art on your walls.', 'marker', FALSE, 1, 2, 1);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('WET-113456789101', 'It looks like you are trying to do something. Would you like some help?', 'paperclip', FALSE, 3, 6, 3);
INSERT INTO collectible (cataloguenumber, description, name, sold, age_id, category_id, condition_id) VALUES ('LWE-123456789101', 'I am a banana', 'banana', TRUE, 4, 5, 5);
